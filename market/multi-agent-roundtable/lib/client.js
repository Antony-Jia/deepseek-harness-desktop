...
.mar-shell,.mar-direct-stage,.mar-overlay-panel,.mar-settings{color-scheme:inherit;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-base)}
.mar-chat-header,.mar-toolbar,.mar-settings-section,.mar-role-editor,.mar-team-editor,.mar-overlay-header{border-color:var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary)}
.mar-chat-scroll{background:var(--dsw-alias-bg-base)}
.mar-topic-input,.mar-control select,.mar-control input,.mar-settings input,.mar-settings select,.mar-settings textarea,.mar-sidebar-editor input,.mar-sidebar-editor textarea,.mar-history-select{border-color:var(--dsw-alias-border-l2);background:var(--dsw-specific-input-major);color:var(--dsw-alias-label-primary)}
.mar-primary{border-color:var(--dsw-alias-button-info-fill);background:var(--dsw-alias-button-info-fill);color:var(--dsw-alias-label-primary-foreground)}.mar-primary:hover{background:var(--dsw-alias-button-info-hover)}
.mar-secondary,.mar-header-action,.mar-role-chip,.mar-team-member{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:transparent}.mar-secondary:hover,.mar-header-action:hover,.mar-role-chip:hover,.mar-team-member:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}
.mar-role-chip[data-active=true],.mar-team-member[data-active=true],.mar-sidebar-role[data-active=true],.mar-mode-switch-card{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-tertiary);color:var(--dsw-alias-label-primary)}
.mar-sidebar-role:hover,.mar-message-toggle:hover{background:var(--dsw-alias-interactive-bg-hover)}
.mar-message-bubble{border-color:var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary)}
.mar-message[data-own=true] .mar-message-bubble{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-specific-bubble);color:var(--dsw-alias-label-primary)}
.mar-message[data-own=true] .mar-markdown,.mar-message[data-own=true] .mar-markdown h1,.mar-message[data-own=true] .mar-markdown h2,.mar-message[data-own=true] .mar-markdown h3,.mar-markdown,.mar-markdown h1,.mar-markdown h2,.mar-markdown h3,.mar-welcome h3{color:var(--dsw-alias-label-primary)}
.mar-message-head,.mar-message-round,.mar-control,.mar-row-label,.mar-section-head p,.mar-role-editor label,.mar-default-fields label,.mar-inline-check,.mar-team-id,.mar-sidebar-role-state,.mar-sidebar-editor label,.mar-chat-header p,.mar-discussion-meta,.mar-empty,.mar-welcome{color:var(--dsw-alias-label-secondary)}
.mar-participant,.mar-message-toggle,.mar-reasoning{border-color:var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-secondary)}
.mar-reasoning-content{border-color:var(--dsw-alias-border-l2)}.mar-reasoning-content .mar-markdown{color:var(--dsw-alias-label-secondary)}
.mar-markdown blockquote{background:var(--dsw-alias-state-business-tertiary);color:var(--dsw-alias-label-secondary)}.mar-markdown code{background:var(--dsw-alias-markdown-inline-code);color:var(--dsw-alias-label-primary)}.mar-code{background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-primary)}.mar-table th{background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-primary)}.mar-table td{background:var(--dsw-alias-bg-layer-1)}
.mar-overlay{background:var(--dsw-alias-bg-mask-1)}.mar-overlay-panel{box-shadow:-16px 0 42px var(--dsw-alias-bg-mask-2)}
.mar-status{background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-secondary)}.mar-status[data-status=running]{background:var(--dsw-alias-state-business-tertiary);color:var(--dsw-alias-state-business-primary)}.mar-status[data-status=completed]{background:var(--dsw-alias-state-success-tertiary);color:var(--dsw-alias-state-success-primary)}
.mar-status[data-status=failed],.mar-participant[data-status=failed]{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.mar-status[data-status=cancelled]{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-label)}
.mar-error{border-color:var(--dsw-alias-state-error-primary);background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.mar-note{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-tertiary);color:var(--dsw-alias-label-primary)}
.mar-cancel,.mar-participant-cancel{border-color:var(--dsw-alias-state-error-primary);background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.mar-stream-state,.mar-isolation-note{background:var(--dsw-alias-state-success-tertiary);color:var(--dsw-alias-state-success-primary)}.mar-streaming{color:var(--dsw-alias-state-business-primary)}
.mar-welcome-icon{background:var(--dsw-alias-state-business-tertiary);color:var(--dsw-alias-state-business-primary)}.mar-avatar-user{background:var(--dsw-alias-button-info-fill)}.mar-switch-track{background:var(--dsw-alias-bg-overlay)}.mar-switch input:checked+.mar-switch-track{background:var(--dsw-alias-button-info-fill)}
.mar-topic-input:focus,.mar-control select:focus,.mar-control input:focus,.mar-settings input:focus,.mar-settings textarea:focus{outline-color:color-mix(in srgb,var(--dsw-alias-state-business-primary) 35%,transparent);border-color:var(--dsw-alias-state-business-primary)}
