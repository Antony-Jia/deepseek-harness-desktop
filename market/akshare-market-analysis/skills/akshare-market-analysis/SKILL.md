...
description: Use the registered AKShare market tools for A-share or Hong Kong stock snapshots, history, K-lines, and descriptive technical analysis; do not use for trading execution or arbitrary Python.
---

# AKShare 行情与 K 线分析

只在用户需要 A 股或港股行情、历史日/周/月 K 线、筛选排行或 SMA/MACD/RSI/BOLL/VMA/ATR 分析时使用本 Skill。
...
- A 股代码规范化为 6 位字符串，港股代码规范化为 5 位字符串并保留前导零。市场有歧义时先澄清。
