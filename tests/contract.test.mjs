...
test('plugin market contract is represented in the Rust, UI and fixture layers', () => {
  ...
  assert.match(mainRust, /start_market_background_scan/)
  assert.match(mainRust, /acknowledge_market_updates/)
  ...
  assert.match(rust, /market-scan-v1\.json/)
  assert.match(rust, /merge_pending_updates/)
  ...
  assert.match(html, /market-update-badge/)
  assert.match(html, /id="market-view"/)
  assert.match(html, /market-search-form/)
  assert.match(html, /market-refresh-button/)
  ...
  assert.match(javascript, /forceRefresh/)
  assert.match(javascript, /acknowledge_market_updates/)
  assert.match(javascript, /start_market_background_scan/)
